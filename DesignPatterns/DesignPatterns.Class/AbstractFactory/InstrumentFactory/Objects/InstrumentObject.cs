...
namespace DesignPatterns.Class.AbstractFactory.InstrumentFactory.Objects
{
    ...
    {
        private static Dictionary<string, Instrument> catalogIbanez = new Dictionary<string, Instrument>()
        {
        ...
        private static Dictionary<string, Instrument> catalogGibson = new Dictionary<string, Instrument>()
        {
        ...
        private static Dictionary<string, Instrument> catalogYamaha = new Dictionary<string, Instrument>()
        {
            ...
            { "DTX10K", new Piano("YDP-145", "Numérique", 899, 88) },
        ...
        public static Dictionary<string, Instrument> GetCatalogIbanez { get { return catalogIbanez; } }
        public static Dictionary<string, Instrument> GetcatalogGibson { get { return catalogGibson; } }
        public static Dictionary<string, Instrument> GetcatalogYamaha { get { return catalogYamaha; } }
    }
}
